...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(net.opentrends.training.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<net.opentrends.training.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public net.opentrends.training.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public net.opentrends.training.model.Foo toUnescapedModel() {
