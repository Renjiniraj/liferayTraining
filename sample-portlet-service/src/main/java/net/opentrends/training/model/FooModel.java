 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link net.opentrends.training.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link net.opentrends.training.model.impl.FooImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see Foo
 * @see net.opentrends.training.model.impl.FooImpl
 * @see net.opentrends.training.model.impl.FooModelImpl
 * @generated
 */
public interface FooModel extends BaseModel<Foo>, StagedGroupedModel {
    ...
    @Override
    public CacheModel<net.opentrends.training.model.Foo> toCacheModel();
