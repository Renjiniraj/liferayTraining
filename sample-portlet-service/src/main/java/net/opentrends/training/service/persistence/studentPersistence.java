...
public interface studentPersistence extends BasePersistence<student> {
    ...
    */
    public void cacheResult(net.opentrends.training.model.student student);
    ...
    */
    public net.opentrends.training.model.student create(long id);
    ...
    */
    public net.opentrends.training.model.student remove(long id)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchstudentException;

    public net.opentrends.training.model.student updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.student findByPrimaryKey(long id)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchstudentException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.student fetchByPrimaryKey(long id)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<net.opentrends.training.model.student> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
