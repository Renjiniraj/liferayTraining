...
public interface departmentPersistence extends BasePersistence<department> {
    ...
    */
    public net.opentrends.training.model.department create(long id);
    ...
    */
    public net.opentrends.training.model.department remove(long id)
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.department findByPrimaryKey(long id)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchdepartmentException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.department fetchByPrimaryKey(long id)
        throws com.liferay.portal.kernel.exception.SystemException;
