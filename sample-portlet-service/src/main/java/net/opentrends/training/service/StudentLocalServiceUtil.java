 ...
 * {@link net.opentrends.training.service.impl.StudentLocalServiceImpl} and is the
 ...
 * @see net.opentrends.training.service.impl.StudentLocalServiceImpl
 * @generated
 */
public class StudentLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.training.service.impl.StudentLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.training.model.Student addStudent(
    ...
    */
    public static net.opentrends.training.model.Student createStudent(
        long studentid) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student deleteStudent(
        long studentid)
    ...
    */
    ...
    public static net.opentrends.training.model.Student fetchStudent(
        long studentid)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student getStudent(
        long studentid)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.training.model.Student> getStudents(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student updateStudent(
        net.opentrends.training.model.Student student)
        throws com.liferay.portal.kernel.exception.SystemException {
