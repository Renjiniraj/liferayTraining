...
public interface StudentPersistence extends BasePersistence<Student> {
    ...
    */
    public net.opentrends.training.model.Student create(long studentid);
    ...
    */
    public net.opentrends.training.model.Student remove(long studentid)
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Student findByPrimaryKey(
        long studentid)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchStudentException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Student fetchByPrimaryKey(
        long studentid)
        throws com.liferay.portal.kernel.exception.SystemException;
