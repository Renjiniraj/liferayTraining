...
public class EmployeeUtil {
    ...
    */
    public static void cacheResult(
        net.opentrends.training.model.Employee employee) {
    ...
    */
    public static void cacheResult(
        java.util.List<net.opentrends.training.model.Employee> employees) {
    ...
    */
    public static net.opentrends.training.model.Employee create(long empId) {
    ...
    * @throws net.opentrends.training.NoSuchEmployeeException if a employee with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee remove(long empId)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchEmployeeException {
        return getPersistence().remove(empId);
    }

    public static net.opentrends.training.model.Employee updateImpl(
        net.opentrends.training.model.Employee employee)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    /**
    * Returns the employee with the primary key or throws a {@link net.opentrends.training.NoSuchEmployeeException} if it could not be found.
    *
    * @param empId the primary key of the employee
    * @return the employee
    * @throws net.opentrends.training.NoSuchEmployeeException if a employee with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee findByPrimaryKey(
        long empId)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchEmployeeException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee fetchByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.training.model.Employee> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static EmployeePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (EmployeePersistence) PortletBeanLocatorUtil.locate(net.opentrends.training.service.ClpSerializer.getServletContextName(),
