...
public interface DepartmentPersistence extends BasePersistence<Department> {
    ...
    */
    public void cacheResult(net.opentrends.training.model.Department department);
    ...
    */
    public net.opentrends.training.model.Department create(long departmentid);
    ...
    */
    public net.opentrends.training.model.Department remove(long departmentid)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchDepartmentException;

    public net.opentrends.training.model.Department updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Department findByPrimaryKey(
        long departmentid)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchDepartmentException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Department fetchByPrimaryKey(
        long departmentid)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<net.opentrends.training.model.Department> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
