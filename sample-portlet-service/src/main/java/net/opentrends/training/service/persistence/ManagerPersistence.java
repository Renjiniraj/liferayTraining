...
public interface ManagerPersistence extends BasePersistence<Manager> {
    ...
    */
    public void cacheResult(net.opentrends.training.model.Manager manager);
    ...
    */
    public net.opentrends.training.model.Manager create(long manageentryID);
    ...
    */
    public net.opentrends.training.model.Manager remove(long manageentryID)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchManagerException;

    public net.opentrends.training.model.Manager updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Manager findByPrimaryKey(
        long manageentryID)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchManagerException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Manager fetchByPrimaryKey(
        long manageentryID)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<net.opentrends.training.model.Manager> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
