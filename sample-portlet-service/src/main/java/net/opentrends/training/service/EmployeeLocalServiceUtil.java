 ...
 * {@link net.opentrends.training.service.impl.EmployeeLocalServiceImpl} and is the
 ...
 * @see net.opentrends.training.service.impl.EmployeeLocalServiceImpl
 * @generated
 */
public class EmployeeLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.training.service.impl.EmployeeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.training.model.Employee addEmployee(
    ...
    */
    public static net.opentrends.training.model.Employee createEmployee(
        long empId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee deleteEmployee(
        long empId)
    ...
    */
    ...
    public static net.opentrends.training.model.Employee fetchEmployee(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee getEmployee(long empId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.training.model.Employee> getEmployees(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Employee updateEmployee(
        net.opentrends.training.model.Employee employee)
        throws com.liferay.portal.kernel.exception.SystemException {
