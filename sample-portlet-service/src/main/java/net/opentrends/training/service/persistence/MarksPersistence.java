...
public interface MarksPersistence extends BasePersistence<Marks> {
    ...
    */
    public net.opentrends.training.model.Marks create(long marksid);
    ...
    */
    public net.opentrends.training.model.Marks remove(long marksid)
    ...
    * @throws SystemException if a system exception occurred
    */
    public net.opentrends.training.model.Marks findByPrimaryKey(long marksid)
        throws com.liferay.portal.kernel.exception.SystemException,
            net.opentrends.training.NoSuchMarksException;
