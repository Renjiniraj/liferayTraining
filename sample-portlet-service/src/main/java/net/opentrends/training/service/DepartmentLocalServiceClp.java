...
public class DepartmentLocalServiceClp implements DepartmentLocalService {
    ...
    public net.opentrends.training.model.Department addDepartment(
        ...
        return (net.opentrends.training.model.Department) ClpSerializer.translateOutput(returnObj);
    }

    @Override
    public net.opentrends.training.model.Department createDepartment(
        long departmentid) {
        Object returnObj = null;
    ...
    @Override
    public net.opentrends.training.model.Department fetchDepartment(
        long departmentid)
        throws com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
    ...
    @Override
    public net.opentrends.training.model.Department getDepartment(
        long departmentid)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
    ...
    public java.util.List<net.opentrends.training.model.Department> getDepartments(
        ...
        return (java.util.List<net.opentrends.training.model.Department>) ClpSerializer.translateOutput(returnObj);
    }
