 ...
 * {@link net.opentrends.training.service.impl.FooLocalServiceImpl} and is the
 ...
 * @see FooLocalService
 * @see net.opentrends.training.service.base.FooLocalServiceBaseImpl
...
public class FooLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.training.service.impl.FooLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.training.model.Foo addFoo(
    ...
    * @return the new foo
    */
    public static net.opentrends.training.model.Foo createFoo(long fooId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo deleteFoo(long fooId)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo deleteFoo(
        net.opentrends.training.model.Foo foo)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static net.opentrends.training.model.Foo fetchFoo(long fooId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo fetchFooByUuidAndCompanyId(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo fetchFooByUuidAndGroupId(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo getFoo(long fooId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo getFooByUuidAndCompanyId(
        java.lang.String uuid, long companyId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo getFooByUuidAndGroupId(
        java.lang.String uuid, long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.training.model.Foo> getFoos(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Foo updateFoo(
        net.opentrends.training.model.Foo foo)
        throws com.liferay.portal.kernel.exception.SystemException {
