...
public class studentLocalServiceClp implements studentLocalService {
    ...
    public studentLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "findCompleteStudentDetails";
    ...
    public net.opentrends.training.model.student addstudent(
        ...
        return (net.opentrends.training.model.student) ClpSerializer.translateOutput(returnObj);
    }

    @Override
    public net.opentrends.training.model.student createstudent(long id) {
        Object returnObj = null;
    ...
    @Override
    public net.opentrends.training.model.student deletestudent(long id)
    ...
    @Override
    public net.opentrends.training.model.student fetchstudent(long id)
        throws com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
    ...
    @Override
    public net.opentrends.training.model.student getstudent(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
    ...
    public java.util.List<net.opentrends.training.model.student> getstudents(
        ...
        return (java.util.List<net.opentrends.training.model.student>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    @Override
    public java.util.List<net.opentrends.training.model.student> findCompleteStudentDetails()
        throws com.liferay.portal.kernel.exception.SystemException {
        Object returnObj = null;
