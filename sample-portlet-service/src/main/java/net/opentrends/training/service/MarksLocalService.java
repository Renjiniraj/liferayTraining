...
/**
 * Provides the local service interface for Marks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MarksLocalServiceUtil
...
public interface MarksLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MarksLocalServiceUtil} to access the marks local service. Add custom service methods to {@link net.opentrends.training.service.impl.MarksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
