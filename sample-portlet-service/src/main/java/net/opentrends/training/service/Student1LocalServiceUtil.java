 ...
 * {@link net.opentrends.training.service.impl.Student1LocalServiceImpl} and is the
 ...
 * @see net.opentrends.training.service.base.Student1LocalServiceBaseImpl
 * @see net.opentrends.training.service.impl.Student1LocalServiceImpl
 * @generated
 */
public class Student1LocalServiceUtil {
    private static Student1LocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link net.opentrends.training.service.impl.Student1LocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static net.opentrends.training.model.Student1 addStudent1(
    ...
    */
    public static net.opentrends.training.model.Student1 createStudent1(
        long studentid) {
        return getService().createStudent1(studentid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student1 deleteStudent1(
        long studentid)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteStudent1(studentid);
    }
    ...
    */
    ...
    public static net.opentrends.training.model.Student1 fetchStudent1(
        long studentid)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchStudent1(studentid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student1 getStudent1(
        long studentid)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getStudent1(studentid);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<net.opentrends.training.model.Student1> getStudent1s(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static net.opentrends.training.model.Student1 updateStudent1(
        net.opentrends.training.model.Student1 student1)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static Student1LocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    Student1LocalService.class.getName());

            if (invokableLocalService instanceof Student1LocalService) {
                _service = (Student1LocalService) invokableLocalService;
            } else {
                _service = new Student1LocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(Student1LocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(Student1LocalService service) {
    }
}
