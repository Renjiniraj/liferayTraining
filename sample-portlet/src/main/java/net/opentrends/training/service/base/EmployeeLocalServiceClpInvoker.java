...
public class EmployeeLocalServiceClpInvoker {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return EmployeeLocalServiceUtil.addEmployee((net.opentrends.training.model.Employee) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return EmployeeLocalServiceUtil.deleteEmployee((net.opentrends.training.model.Employee) arguments[0]);
        }
