...
public class MarksPersistenceImpl extends BasePersistenceImpl<Marks>
     ...
     */
    @Override
    public Marks create(long marksid) {
        Marks marks = new MarksImpl();

        marks.setNew(true);
        marks.setPrimaryKey(marksid);
     ...
     */
    @Override
    public Marks remove(long marksid)
        throws NoSuchMarksException, SystemException {
        return remove((Serializable) marksid);
    }
    ...
    protected Marks toUnwrappedModel(Marks marks) {
        ...
        marksImpl.setMarksid(marks.getMarksid());
     ...
     */
    @Override
    public Marks findByPrimaryKey(long marksid)
        throws NoSuchMarksException, SystemException {
        return findByPrimaryKey((Serializable) marksid);
    }
     ...
     */
    @Override
    public Marks fetchByPrimaryKey(long marksid) throws SystemException {
        return fetchByPrimaryKey((Serializable) marksid);
    }
