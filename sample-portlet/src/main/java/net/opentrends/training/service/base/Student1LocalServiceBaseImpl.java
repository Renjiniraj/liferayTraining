...
import net.opentrends.training.service.Student1LocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.opentrends.training.service.impl.Student1LocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see net.opentrends.training.service.impl.Student1LocalServiceImpl
 * @see net.opentrends.training.service.Student1LocalServiceUtil
 * @generated
 */
public abstract class Student1LocalServiceBaseImpl extends BaseLocalServiceImpl
    implements Student1LocalService, IdentifiableBean {
    ...
    private Student1LocalServiceClpInvoker _clpInvoker = new Student1LocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link net.opentrends.training.service.Student1LocalServiceUtil} to access the student1 local service.
     */
    ...
    @Override
    public Student1 addStudent1(Student1 student1) throws SystemException {
     ...
     */
    @Override
    public Student1 createStudent1(long studentid) {
        return student1Persistence.create(studentid);
    }
    ...
    @Override
    public Student1 deleteStudent1(long studentid)
        throws PortalException, SystemException {
        return student1Persistence.remove(studentid);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Student1 deleteStudent1(Student1 student1) throws SystemException {
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Student1.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return student1Persistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return student1Persistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    @Override
    public Student1 fetchStudent1(long studentid) throws SystemException {
        return student1Persistence.fetchByPrimaryKey(studentid);
    }
     ...
     */
    @Override
    public Student1 getStudent1(long studentid)
        throws PortalException, SystemException {
        return student1Persistence.findByPrimaryKey(studentid);
    }
     ...
     */
    @Override
    public int getStudent1sCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Student1 updateStudent1(Student1 student1) throws SystemException {
        return student1Persistence.update(student1);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("net.opentrends.training.model.Student1",
