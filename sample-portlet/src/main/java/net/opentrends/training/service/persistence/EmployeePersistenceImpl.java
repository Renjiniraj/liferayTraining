...
import net.opentrends.training.NoSuchEmployeeException;
import net.opentrends.training.model.Employee;
import net.opentrends.training.model.impl.EmployeeImpl;
import net.opentrends.training.model.impl.EmployeeModelImpl;
...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
    ...
    @Override
    public Employee updateImpl(net.opentrends.training.model.Employee employee)
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.net.opentrends.training.model.Employee")));
