...
import net.opentrends.training.service.ManagerLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link net.opentrends.training.service.impl.ManagerLocalServiceImpl}.
 * </p>
 *
...
public abstract class ManagerLocalServiceBaseImpl extends BaseLocalServiceImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link net.opentrends.training.service.ManagerLocalServiceUtil} to access the manager local service.
     */
     ...
     */
    @Override
    public Manager createManager(long manageentryID) {
        return managerPersistence.create(manageentryID);
    }
    ...
    @Override
    public Manager deleteManager(long manageentryID)
        throws PortalException, SystemException {
        return managerPersistence.remove(manageentryID);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Manager deleteManager(Manager manager) throws SystemException {
    ...
    @Override
    public Manager fetchManager(long manageentryID) throws SystemException {
        return managerPersistence.fetchByPrimaryKey(manageentryID);
    }
     ...
     */
    @Override
    public Manager getManager(long manageentryID)
        throws PortalException, SystemException {
        return managerPersistence.findByPrimaryKey(manageentryID);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("net.opentrends.training.model.Manager",
            managerLocalService);
    }
